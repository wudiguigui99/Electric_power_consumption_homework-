...
working_data<-filter(data_col, as.character(data_col$Date) =="1/2/2007" | as.character(data_col$Date)== "2/2/2007")
...
plot(data$SetTime, as.numeric(data$Global_active_power), type="l", col="black", xlab="", ylab="Global Active Power (kilowatts)")
